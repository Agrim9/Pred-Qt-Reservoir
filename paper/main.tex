...
The key advantage of a reservoir computing based system is that it is easy to train in comparison to its counterparts like Deep Neural Networks \cite{mosleh2017brain}.
...
Reservoir computing has been successfully used to solve problems like handwritten digit image recognition \cite{jalalvand2015real}, spoken digit recognition \cite{verstraeten2005isolated}, and climate prediction \cite{pathak2017using}.
}
